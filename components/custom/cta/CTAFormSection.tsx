...
export default function CTAFormSection() {
  ...
  const WHY_LEFT = [
    ...
    "Licensed and insured — EC-13007758",
    "Residential and commercial expertise",
    "Free estimates on all projects",
  ];
  const WHY_RIGHT = [
    "Veteran-owned and family operated",
    "Authorized Generac dealer since 2016",
      ...
      <div className="cta-form__container">
        ...
        <div className="cta-form__left p-10!">
          ...
          <h2 className="cta-form__heading hidden md:block">
            We stay in touch from <br />start to finish — and beyond
          </h2>
          <h2 className="cta-form__heading block md:hidden">
            Get in touch
          </h2>
          <p className="cta-form__subtext hidden md:block">
            From bidding through permitting to completion — we communicate
            <br />every step. Emergency service available 24 hours.
          </p>
        ...
        <div className="cta-form__right">
          ...
          <p className="cta-form__text">
            GO Electric Services provides licensed residential and commercial electrical work
            throughout Palm Beach County. Panel upgrades, full rewires, generator installs,
            smart home, and outdoor electrical — all permitted, inspected, and code-compliant.
          </p>
          <p className="cta-form__text">
            Veteran-owned and family-operated since 2016. We&apos;re committed to keeping you
            informed at every stage — from the free estimate through final inspection sign-off.
          </p>
