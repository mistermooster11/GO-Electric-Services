      ...
      <div className="testimonials__container">
        ...
        <div className="testimonials__header">
          ...
          <p className="testimonials__subtext">
            Our clients across Palm Beach County rely on GO Electric for fast response, licensed
            electrical work, and reliable service — from panel upgrades and generator installation
            to full home rewires and commercial projects.
          </p>
        </div>
