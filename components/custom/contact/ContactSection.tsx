          ...
          <div className="contact-section__details">
            ...
            <div className="contact-section__details-col">
              ...
              <p className="contact-detail__value">
                1616 North Florida Mango Road,&nbsp;West Palm Beach,&nbsp;FL&nbsp;33409
              </p>

              <h5 className="contact-detail__label">Follow us</h5>
              <div className="contact-section__social">
                <Link href="[TODO: Add GO Electric Twitter/X URL if available]" className="contact-social-icon" aria-label="Twitter" target="_blank" rel="noopener noreferrer">
                ...
                <Link href="https://www.facebook.com/GOElectricServicesLLC/" className="contact-social-icon" aria-label="Facebook" target="_blank" rel="noopener noreferrer">
                ...
                <Link href="https://www.instagram.com/goelectric9908/" className="contact-social-icon" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
                  <svg aria-hidden="true" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor">
            ...
            <div className="contact-section__details-col">
              ...
              <p className="contact-detail__value">
                <Link href="tel:+15613158448">(561) 315-8448</Link>
              </p>

              <h5 className="contact-detail__label">Email</h5>
              <p className="contact-detail__value">
                {/* TODO: Add GO Electric email address */}
                <Link href="mailto:info@goelectricservices.com">info@goelectricservices.com</Link>
              </p>
            </div>
