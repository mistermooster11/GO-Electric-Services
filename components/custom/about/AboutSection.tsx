      ...
      <div className="about__container">
        ...
        <div className="about__content">
          ...
          <p className="about__text">
            GO Electric Services, LLC is a veteran-owned, family business dedicated to customer
            service, safety, and peace of mind. Founded by Mark Giarrizzo — a 27-year US Navy
            Electrical Officer — GO Electric brings military-grade discipline to every job in
            Palm Beach County.
          </p>
          <p className="about__text">
            We provide thorough consultations, explain your options clearly, and help you choose
            the scope of work that fits your home, business, and budget. Every job is permitted,
            inspected, and code-compliant before we close out.
          </p>
        ...
        <div className="about__media">
          <div className="about__img-wrap">
            {/* TODO: Replace with GO Electric team/work photo */}
            <Image
              src="/images/about-row.webp"
              alt="GO Electric Services team"
              width={690}
              height={613}
