  ...
  return (
    <footer className="footer">
      ...
      <div className="footer__top">
        <div className="footer__brand">
          ...
          <p className="footer__desc">
            <strong>GO Electric Services</strong> is a veteran-owned electrical contractor serving
            Palm Beach County since 2016. Licensed, insured, and Generac-authorized — residential,
            commercial, and emergency electrical work done right.
          </p>
          <div className="footer__socials">
            <a href="https://www.facebook.com/GOElectricServicesLLC/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="footer__social-link">
            ...
            <a href="https://www.instagram.com/goelectric9908/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="footer__social-link">
            ...
            <a href="[TODO: Add GO Electric LinkedIn URL if available]" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="footer__social-link">
            ...
            <a href="[TODO: Add GO Electric TikTok URL if available]" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="footer__social-link">
            ...
            <a href="https://www.yelp.com/biz/go-electric-services-west-palm-beach" target="_blank" rel="noopener noreferrer" aria-label="Yelp" className="footer__social-link">
      ...
      <div className="footer__bottom">
        <p className="footer__copyright">Copyright 2025 GO Electric Services, LLC. All rights reserved.</p>
