    ...
    <section className="need-services" ref={sectionRef}>
      <div className="need-services__inner">
        <h2 className="need-services__heading">
          ...
          <br />in Palm Beach County?
        </h2>
        <p className="need-services__text">
          Request a free estimate for residential or commercial electrical work —
          <br />veteran-owned, fully licensed, and available for 24-hour emergencies.
        </p>
